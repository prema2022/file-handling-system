...
<input type="hidden" id="status" value="<%= request.getAttribute("status") %>">
    <h1 style="color: black;"> User Register Portal</h1>
    <form  action="<%= request.getContextPath() %>/Userregister"  method="post">
        ...
        <div class="mainContainer">
            ...
            <br><br>
            <label for="pswrd">Your password</label>
            <input type="password" placeholder="Enter Password" name="passkey1" required>
            ...
            <button type="submit"><a style="text-decoration: none; color: white;" href="<%= request.getContextPath() %>/userlogin" class="button">Back To Login</a></button> 
